 ...
 */
!function(a){"use strict";a.fn.cmsmastersFixedHeaderScroll=function(b){var c={headerTop:".header_top",headerMid:".header_mid",headerBot:".header_bot",navBlock:"nav",navList:"#navigation",navTopList:"#top_line_nav",respNavButton:".responsive_nav",respTopNavButton:".responsive_top_nav",fixedClass:".fixed_header",fixedClassBlock:"#page",respHideBlocks:"",maxWidthMid:1024,maxWidthBot:1024,changeTopHeight:!0,changeMidHeight:!0,mobileDisabled:!0},d=this,e={};e={init:function(){e.options=e.o=a.extend({},c,b),e.el=d,e.vars=e.v={},e.v.newTopHeight=0,e.v.newMidHeight=50,e.setHeaderVars(),e.startHeader()},setHeaderVars:function(){e.v.headerMidString=e.o.headerMid,e.v.headerTop=e.el.find("> "+e.o.headerTop),e.v.headerMid=e.el.find("> "+e.v.headerMidString),e.v.headerBot=e.el.find("> "+e.o.headerBot),e.v.respNavButton=e.el.find(e.o.respNavButton),e.v.respTopNavButton=e.el.find(e.o.respTopNavButton),e.v.respHideBlocks=a(e.o.respHideBlocks),e.v.navListString=e.o.navList,e.v.navTopListString=e.o.navTopList,e.v.navBlockString=e.o.navBlock,e.v.navBlock=e.el.find(e.v.navListString).parents(e.v.navBlockString),e.v.navTopBlock=e.el.find(e.v.navTopListString).parents(e.v.navBlockString),e.v.midChangeHeightBlocksResp=a(e.v.headerMidString+", "+e.v.headerMidString+" .header_mid_outer, "+e.v.headerMidString+" "+e.v.navListString+", "+e.v.headerMidString+" "+e.v.navListString+" > li, "+e.v.headerMidString+" "+e.v.navListString+" > li > a, "+e.v.headerMidString+" "+e.v.navListString+" > li > a > span.nav_bg_clr"),e.v.topHeight=0,e.v.midHeight=0,e.v.botHeight=0,e.v.win=a(window),e.v.winScrollTop=e.v.win.scrollTop(),e.v.winMidScrollTop=e.v.winScrollTop-e.v.topHeight-e.v.midHeight,e.v.isMobile="ontouchstart"in document.documentElement},startHeader:function(){e.v.headerTop.length>0&&(e.v.topHeight=Number(e.v.headerTop.attr("data-height"))),e.v.headerMid.length>0&&(e.v.midHeight=Number(e.v.headerMid.attr("data-height"))),e.v.headerBot.length>0&&(e.v.botHeight=Number(e.v.headerBot.attr("data-height"))),0==e.v.winScrollTop&&e.el.css({opacity:1}),e.attachEvents(),e.v.win.trigger("scroll")},attachEvents:function(){e.v.respNavButton.bind("click",function(){return e.v.respNavButton.is(":not(.active)")?(e.v.navBlock.css({display:"block"}),e.v.respHideBlocks.css({display:"none"}),e.v.respNavButton.addClass("active")):(e.v.navBlock.css({display:"none"}),e.v.respHideBlocks.css({display:"block"}),e.v.respNavButton.removeClass("active")),!1}),e.v.respTopNavButton.bind("click",function(){return e.v.respTopNavButton.is(":not(.active)")?(e.v.navTopBlock.css({display:"block"}),e.v.respHideBlocks.css({display:"none"}),e.v.respTopNavButton.addClass("active")):(e.v.navTopBlock.css({display:"none"}),e.v.respHideBlocks.css({display:"block"}),e.v.respTopNavButton.removeClass("active")),!1}),e.v.win.bind("scroll",function(){return!e.el.parents(e.o.fixedClassBlock).is(":not("+e.o.fixedClass+")")&&void(cmsmasters_media_width()>e.o.maxWidthMid&&e.getScrollTop())}),e.v.win.bind("resize",function(){e.headerResize(e.v.headerBot.length>0?e.o.maxWidthBot:e.o.maxWidthMid)})},getScrollTop:function(){e.v.winScrollTop=e.v.win.scrollTop(),e.v.winMidScrollTop=e.v.winScrollTop-e.v.topHeight-e.v.midHeight,e.v.winScrollTop>e.v.topHeight+e.v.midHeight+e.v.botHeight?e.el.css({paddingTop:e.v.botHeight,opacity:1}).addClass("navi_scrolled"):e.el.removeClass("navi_scrolled").css({paddingTop:0,opacity:1})},headerResize:function(a){return e.el.parents(e.o.fixedClassBlock).is(":not("+e.o.fixedClass+")")?(e.v.navBlock.removeAttr("style"),!1):void(cmsmasters_media_width()>a?(e.v.navBlock.removeAttr("style"),e.v.respHideBlocks.removeAttr("style"),e.v.respNavButton.removeClass("active"),e.getScrollTop()):e.el.removeAttr("style").removeClass("navi_scrolled").css({opacity:1}))}},e.init()}}(jQuery);
 ...
 */
!function(a){"use strict";a.fn.cmsmastersResponsiveNav=function(b){var c={submenu:"ul.sub-menu",respButton:".responsive_nav",startWidth:1024},d=this,e={};e={init:function(){e.o=a.extend({},c,b),e.el=d,e.v={},e.v.pLinkText="",e.v.subLinkToggle=void 0,e.setVars(),e.restartNav()},setVars:function(){e.v.submenu=e.el.find(e.o.submenu),e.v.subLink=e.v.submenu.closest("li").find("> a"),e.v.respButton=a(e.o.respButton),e.v.startWidth=e.o.startWidth,e.v.win=a(window),e.v.trigger=!1,e.v.counter=0,e.startEvent()},buildNav:function(){e.v.trigger=!0,e.v.counter=1,e.v.subLink.each(function(){""===a(this).text()&&(e.v.pLinkText=a(this).closest("ul").closest("li").find("> a").text(),a(this).addClass("cmsmasters-resp-nav-custom-text").text(e.v.counter+". "+e.v.pLinkText),e.v.counter+=1),a(this).append('<span class="cmsmasters-resp-nav-toggle cmsmasters-icon-angle-down" />')}),e.v.subLinkToggle=e.v.subLink.find("> span.cmsmasters-resp-nav-toggle"),e.v.submenu.hide(),e.attachEvents()},restartNav:function(){!e.v.trigger&&cmsmasters_media_width()<=e.v.startWidth?e.buildNav():e.v.trigger&&cmsmasters_media_width()>e.v.startWidth&&e.destroyNav()},resetNav:function(){e.v.subLinkToggle.removeClass("cmsmasters-icon-angle-up").addClass("cmsmasters-icon-angle-down"),e.v.submenu.hide()},destroyNav:function(){e.v.subLink.each(function(){a(this).hasClass("cmsmasters-resp-nav-custom-text")&&a(this).removeClass("cmsmasters-resp-nav-custom-text").text(""),a(this).find("span.cmsmasters-resp-nav-toggle").remove()}),e.v.submenu.css("display",""),e.v.trigger=!1,e.detachEvents()},startEvent:function(){e.v.win.on("resize",function(){e.restartNav()})},attachEvents:function(){e.v.subLinkToggle.on("click",function(){return a(this).hasClass("cmsmasters-icon-angle-up")?(a(this).removeClass("cmsmasters-icon-angle-up").addClass("cmsmasters-icon-angle-down").closest("li").find("ul.sub-menu").hide(),a(this).closest("li").find("span.cmsmasters-resp-nav-toggle").removeClass("cmsmasters-icon-angle-up").addClass("cmsmasters-icon-angle-down")):a(this).removeClass("cmsmasters-icon-angle-down").addClass("cmsmasters-icon-angle-up").closest("li").find("ul.sub-menu").eq(0).show(),!1}),e.v.respButton.on("click",function(){e.v.trigger&&a(this).hasClass("active")&&e.resetNav()})},detachEvents:function(){e.v.subLinkToggle.off("click")}},e.init()}}(jQuery);
